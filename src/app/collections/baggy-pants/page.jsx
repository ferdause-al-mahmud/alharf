...
const getProducts = async (
  ...
  try {
    ...
    const apiUrlWithParams = `${apiUrl}/api/collections/baggy-pants?${queryParams.toString()}`;
...
export const metadata = {
  title: "Baggy Pants",
  description:
    " Embrace a carefree style with our baggy pants, featuring an easy, loose fit that combines comfort with contemporary flair. Perfect for any occasion, these pants can be dressed up or down. Whether paired with a fitted top or an oversized sweater, baggy pants add a relaxed vibe to your outfit while ensuring you look effortlessly put together.",
};
...
const Page = async ({ searchParams }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4">
      <div className="py-6">
        <h1 className="text-3xl sm:text-5xl">Baggy Pants</h1>
        <p className="text-[14px] my-6 text-gray-600 sm:text-[18px]">
          Embrace a carefree style with our baggy pants, featuring an easy,
          loose fit that combines comfort with contemporary flair. Perfect for
          any occasion, these pants can be dressed up or down. Whether paired
          with a fitted top or an oversized sweater, baggy pants add a relaxed
          vibe to your outfit while ensuring you look effortlessly put together.
        </p>
      </div>
      ...
      <div>
        ...
        <TempleteProductsContainer
          products={products}
          currentPage={page}
          basePath="/collections/baggy-pants"
        />
      </div>
    </div>
  );
