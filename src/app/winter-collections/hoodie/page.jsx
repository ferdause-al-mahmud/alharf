...
const getProducts = async (
  ...
  try {
    ...
    const apiUrlWithParams = `${apiUrl}/api/winter-collections/hoodie?${queryParams.toString()}`;
...
export const metadata = {
  title: "Hoodie",
  description:
    "Experience ultimate comfort with our classic hoodies, designed for relaxation and style. Made from soft, high-quality fabric, these hoodies feature a cozy fit that's perfect for lounging or layering. Whether you're running errands or hanging out with friends, a hoodie is an essential piece that adds a casual flair to any outfit.",
};
...
const Page = async ({ searchParams }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4">
      <div className="py-6">
        <h1 className="text-3xl sm:text-5xl">Hoodie</h1>
        <p className="text-[14px] my-6 text-gray-600 sm:text-[18px]">
          Experience ultimate comfort with our classic hoodies, designed for
          relaxation and style. Made from soft, high-quality fabric, these
          hoodies feature a cozy fit that&apos;s perfect for lounging or
          layering. Whether you&apos;re running errands or hanging out with
          friends, a hoodie is an essential piece that adds a casual flair to
          any outfit.
        </p>
      </div>
      ...
      <div>
        ...
        <TempleteProductsContainer
          products={products}
          currentPage={page}
          basePath="/winter-collections/hoodie"
        />
      </div>
    </div>
  );
